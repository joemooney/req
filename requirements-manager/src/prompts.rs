...
use crate::project::list_available_projects;

/// Prompts the user for a new requirement
pub fn prompt_new_requirement(store: &mut crate::models::RequirementsStore) -> Result<Requirement> {
...
pub fn prompt_new_feature(store: &mut crate::models::RequirementsStore) -> Result<String> {
    // Get feature name
